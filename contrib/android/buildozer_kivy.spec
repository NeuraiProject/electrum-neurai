...
title = Electrum-Neurai

# (str) Package name
package.name = Electrum_Neurai

# (str) Package domain (needed for android/ios packaging)
package.domain = org.electrum-neurai
...
android.add_activities = org.electrum-neurai.qr.SimpleScannerActivity
