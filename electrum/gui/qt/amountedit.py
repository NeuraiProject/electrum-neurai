...
class XNAAmountEdit(AmountEdit):
...
class FeerateEdit(XNAAmountEdit):
    ...
    def get_amount(self):
        sat_per_byte_amount = XNAAmountEdit.get_amount(self)
